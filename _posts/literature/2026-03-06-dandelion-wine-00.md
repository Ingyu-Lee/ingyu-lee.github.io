...
이 책의 저자는 "화씨 451", "화성 연대기"로 유명한 SF 소설가 레이 브래드버리다. 저자와 뒷표지의 줄거리 요약때문에 SF이겠거니 했는데, 막상 내용은 1920년대의 미국 시골을 배경으로 한 반자전적인 옴니버스식 소설이었다. 기대를 배신한 책이지만 어떻게 살 지에 대해 생각하게 만든 재미있는 책이다.

이 책은 한 소년이 자연 속에서 살아있음을 자각하는 단편, 그리고 마치 사진으로 추억을 기록하는 것처럼 민들레 와인을 빚으며 시간을 박제하는 단편으로 시작한다. 우리는 어릴 때 영원히 살 것처럼 행동한다. 하지만 돈이 없을때 가계부를 쓰고, 시간이 없을때 시간표를 짜는 것처럼, 우리는 성장하며 언젠가 찾아올 죽음에 대해 자각하고, 그리고 그 전에 어떻게 살아갈지에 대해 생각하는 순간이 찾아온다. 이 책은 그런 순간으로 시작한다. 여름방학의 시작, 소년은 삶에 대한 자각과 사건의 기록을 시작한다.
...
마을에 연쇄살인마가 있다는 에피소드에서 라비니아는 연쇄살인마에 맞서 당당하게 대응하려 했지만, 생명의 위협을 직접적으로 느끼는 상황에서의 라비니아는 원초적인 슬픔과 공포를 잘 보여준다. 또 다른 에피소드인, 다른 마을로 이사가는 친구와 이별하게 되는 에피소드에서도 주인공은 상실과 이별의 슬픔을 절절히 보여준다. 스토익한 마음가짐을 가지려 해도 과연 나는 이별의 슬픔과 죽음의 공포 앞에서 상황을 의연하게 마주할 수 있을까, 생각해보게 되는 단편들이었다.

연상이 되는 책은 아주 짧은 문단으로 저자의 삶에 대한 관점을 다룬다는 점에서, 마르쿠스 아우렐리우스의 "명상록", 그리고 "성경"의 코헬렛이 있다. 하지만 피에르 아도가 "명상록 수업"에서 지적했듯이, "명상록"은 무질서한 텍스트인, 비망록의 목적으로 쓰인 것으로 추정되는 점에서 "민들레 와인"같은 흐름은 찾기 어렵다. "성경"의 코헬렛과 비교하기에는, 코헬렛은 다소 삶과 행복의 허망함 그리고 믿음에 대한 강조라는 점에서 철학이 어느 정도 다른 점이 있다.

개인적으로 "민들레 와인"을 읽으며 에피쿠로스 학파와 스토아 학파, 그리고 신플라톤주의에서의 철학적 사유의 단편을 볼 수 있었으며, 동시에 현실에서 그렇게 의연하게 대처하기 어렵다는 것을 볼 수 있던 점이 흥미로웠다. 행복에 대해, 죽음에 대해 평상시에는 그런 철학적 사유에서 배운대로 의연하게 대처하려고 하겠지만, 그것들이 현실로 닥쳤을때 얼마나 가슴아픈지 느낄 수 있던, 재미있으면서도 스스로를 돌아보게 만드는 책이다. 그런 점에서 앞서 짚은 "명상록", "성경"과는 비슷하면서도 다른 매력이 있는 책이다.
