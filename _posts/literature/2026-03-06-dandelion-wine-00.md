...
행복 기계 에피소드는 SF라기엔 소박하다. 그저 캡슐 안에 들어가면 아름다운 이국의 경치를 보여주고 잔잔한 음악을 들려주는 정도이다. 소박하지만, 이 에피소드는 잠깐의 감각적 행복은 상실에 대한 불안과 고통을 가져온다는 것을 잘 보여주었고, 가족애를 추구하는 것으로 잔잔하게 끝나는 에피소드다.
